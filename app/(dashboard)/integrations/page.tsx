...
const INTEGRATIONS = [
  ...
  },
  {
    provider: "trello",
    name: "Trello",
    desc: "Créez des cartes, déplacez des tâches et synchronisez vos boards.",
    icon: "📋",
  ...
  },
  {
    provider: "jira",
    name: "Jira",
    desc: "Créez des tickets, suivez les sprints et automatisez votre backlog.",
    icon: "🔷",
    color: "bg-blue-50 border-blue-100",
    iconBg: "bg-blue-100",
  ...
  },
  {
    ...
    desc: "Répondez automatiquement aux messages clients via WhatsApp.",
    icon: "💚",
  ...
  },
  {
    provider: "telegram",
    name: "Telegram",
    desc: "Envoyez des notifications et alertes via votre bot Telegram.",
    icon: "✈️",
  ...
  },
  {
    ...
    name: "Stripe",
    desc: "Suivez les paiements, relancez les impayés et automatisez la facturation.",
    icon: "💳",
